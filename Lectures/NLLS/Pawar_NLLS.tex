...
\title[NLLS]{\bf Fitting mathematical models to data using Non-linear Least-Squares}
...
\begin{itemize}\itemsep16pt
	...
	\item NLLS in {\tt R}
	\item Afternoon practicals overview
\end{itemize}
...
\begin{itemize}\itemsep12pt
	...
	\item All materials are at: \url{https://goo.gl/8b9vMh}

	\item You will work with multiple examples and on some Exercises.
	
	\item Keep workflow organized in {\tt Code}, {\tt Results}, {\tt Data} as you learnt in the R week! 
	
	\item Your will have demonstrators and me to help you -- You may also talk to us about using NLLS for your own project

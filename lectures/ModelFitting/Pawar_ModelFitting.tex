...
\begin{itemize}[<+->] \itemsep6pt
	...
	\item {\bf Phenomenological model}: The Lynx and Hare Cycles have a significant asynchrony (period shift) of xx years
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Methods you can use in the Miniproject}
...
\item MLE/Bayesian methods: more robust if you are able to calculate the likelihood function --- you will learn this in Term 2, so not recommended

\item AI/machine Learning: most versatile for large amounts of noisy data --- you will be introduced to these at the end of term 2, so definitely not recommended
